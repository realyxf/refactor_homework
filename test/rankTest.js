...
rankTest('rank case 4. voyage zone is china and length is 1.', t => {
  const voyage = {
    zone: 'china',
    length: 1,
  };
...
rankTest('rank case 5. voyage zone is china and length is 5.', t => {
  const voyage = {
    zone: 'china',
    length: 5,
  };
...
rankTest('rank case 6. voyage zone is china and length is 10.', t => {
  const voyage = {
    zone: 'china',
    length: 10,
  };
